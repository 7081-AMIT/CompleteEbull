...
const Personal = ({navigation}) => {
  ...
  const validate = () => {
    var Rgx = /^[a-z ,.'-]+$/i;
    var mRgx = /^[a-z ,.'-]+$/i;
    var lRgx = /^[\p{L}'][ \p{L}'-]*[\p{L}]$/u;
   

    const flag = true;
    if (name === '') {
      setErrorname('*please enter lname ');
      return !flag;
    }
    if (name === '' || name === undefined || name === null) {
      setErrorname('*Please enter lname ');
    ...
    if (!Rgx.test(name)) {
      setErrorname('*Please enter valid lname');
      return !flag;
            ...
            <View style={styles.indtxt}>
              ...
              <View style={styles.ind}>
                <View style={styles.ind1}>
                  <Image
                    source={require('../../Assets/Image/indi.jpeg')}
