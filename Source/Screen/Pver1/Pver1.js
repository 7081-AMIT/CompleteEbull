...
const Pver1 = ({navigation}) => {
  ...
  const phoneValidate = phone => {
    ...
    if (phone === '' || phone === undefined || phone === null) {
      setErrorPhone('Enter valid verification code ');
    } else if (!Rgx.test(phone)) {
      setErrorPhone('please enter valid verification code');
    } else {
      setErrorPhone(null);
    }
  };
  ...
  const validate = () => {
    ...
    const flag = true;
    if (phone === '') {
      setErrorPhone('*please enter verification code');
      return !flag;
    }
    if (phone === '' || phone === undefined || phone === null) {
      setErrorPhone('*Please enter verification code');
